		...
		<div class="layout-container">
			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				...
				<ul class="menu-inner py-1">
					<!-- Dashboard -->
					<li class="menu-item <?php if ($this->uri->segment(1) == 'Admin' && $this->uri->segment(2) == 'cDashboard') {
												echo 'active';
											}  ?>">
						<a href="<?= base_url('Admin/cDashboard') ?>" class="menu-link">
					...
					<!-- <li class="menu-item <?php if ($this->uri->segment(1) == 'Admin' && $this->uri->segment(2) == 'cKategori') {
						...
						<a href="<?= base_url('Admin/cKategori') ?>" class="menu-link">
							<i class="menu-icon tf-icons bx bx-notepad"></i>
							<div data-i18n="Basic">Kategori</div>
						</a>
					</li> -->
					<li class="menu-item <?php if ($this->uri->segment(1) == 'Admin' && $this->uri->segment(2) == 'cProduk') {
												echo 'active';
											}  ?>">
						<a href="<?= base_url('Admin/cProduk') ?>" class="menu-link">
							<i class="menu-icon tf-icons bx bx-qr-scan"></i>
							<div data-i18n="Basic">Produk</div>
						</a>
					</li>
					<li class="menu-item <?php if ($this->uri->segment(1) == 'Admin' && $this->uri->segment(2) == 'cDiskon') {
												echo 'active';
											}  ?>">
						<a href="<?= base_url('Admin/cDiskon') ?>" class="menu-link">
					...
					<!-- Tables -->
					<li class="menu-item">
						<a href="<?= base_url('cLogin/logout') ?>" class="menu-link">
