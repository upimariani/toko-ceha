...
<script src="<?= base_url('asset/analisis/chart/js_chart.js') ?>"></script>
<script>
	<?php
	$data = $this->db->query("SELECT SUM(total_bayar) as total, tgl_transaksi FROM `transaksi` GROUP BY tgl_transaksi")->result();
