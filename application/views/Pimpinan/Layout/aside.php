			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				<div class="app-brand demo">
					<a href="index.html" class="app-brand-link">
						...
						<span class="app-brand-text demo menu-text fw-bolder ms-2">Pimpinan</span>
					</a>
				...
				<ul class="menu-inner py-1">
					<!-- Dashboard -->
					<li class="menu-item <?php if ($this->uri->segment(1) == 'Pimpinan' && $this->uri->segment(2) == 'cDashboard') {
												echo 'active';
											}  ?>">
						<a href="<?= base_url('Pimpinan/cDashboard') ?>" class="menu-link">
					...
					<li class="menu-item <?php if ($this->uri->segment(1) == 'Pimpinan' && $this->uri->segment(2) == 'cLaporan_transaksi') {
												echo 'active';
											}  ?>">
						<a href="<?= base_url('Pimpinan/cLaporan_transaksi') ?>" class="menu-link">
