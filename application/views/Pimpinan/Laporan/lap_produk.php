        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card card-light">
                    ...
                    <div class="card-body">
                        <?php
                        echo form_open('Admin/cAnalisis_Produk/lap_harian_produk') ?>
                        <div class="row">
                            <div class="col-sm-4">
            ...
            <div class="col-md-4">
                <div class="card card-light">
                    ...
                    <div class="card-body">
                        <?php
                        echo form_open('Admin/cAnalisis_Produk/lap_bulanan_produk') ?>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Bulan</label>
            ...
            <div class="col-md-4">
                <div class="card card-light">
                    ...
                    <div class="card-body">
                        <?php
                        echo form_open('Admin/cAnalisis_Produk/lap_tahunan_produk') ?>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Tahun</label>
