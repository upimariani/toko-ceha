						...
						<div class="col-lg-5">
							<div class="right">
								...
								<ul>
									...
									<li>Atas Nama<span><?= $detail['transaksi']->nama_konsumen ?></span></li>
									<li>No Telepon<span><?= $detail['transaksi']->no_hp_konsumen ?></span></li>
								</ul>
							</div>
						</div>
						<div class="col-lg-7 col-md-7 col-12">
							<div class="right">
								...
								<ul>
									...
									<li>Alamat Pengiriman<span><?= $detail['transaksi']->alamat_konsumen ?> Kec. <?= $detail['transaksi']->nama_kecamatan ?></span></li>
									</li>
								</ul>
							</div>
						</div>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td class="text-center"><?= $value->quantity ?> x</td>
								<td class="text-center">Rp. <?= number_format($value->harga - ($value->harga * $value->besar_diskon / 100))  ?></td>
								<td class="text-center">Rp. <?= number_format(($value->harga - ($value->harga * $value->besar_diskon / 100)) * $value->quantity) ?></td>
							</tr>
						<?php
						}
						?>
					...
					<div class="row">
						<div class="col-lg-8 col-md-5 col-12">
							...
							?>
								...
								<a href="<?= base_url('pelanggan/cStatusOrder/diterima/' . $detail['transaksi']->id_transaksi) ?>" class="btn mt-3">Konfirmasi</a>
							<?php
							}
							?>
						...
						<div class="col-lg-4 col-md-7 col-12">
							<div class="right">
								<ul>
									<li>Subtotal<span>Rp. <?= number_format($detail['transaksi']->total_bayar - $detail['transaksi']->ongkir) ?></span></li>
